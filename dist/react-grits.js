...
var _stylis = __webpack_require__(17);
...
var mapGridTemplateAreas = function mapGridTemplateAreas(_ref) {
    ...
    return templateAreas.map(function (area) {
        return 'grid-template-areas: "' + area.join(' ') + '";';
    });
};
...
exports.__esModule = true;
exports.GridItem = exports.createGridItemsForChildren = exports.Grid = undefined;
...
Object.defineProperty(exports, 'createGridItemsForChildren', {
  enumerable: true,
  get: function get() {
    return _Grid.createGridItemsForChildren;
  }
});
...
var _SplitHalf = __webpack_require__(21);
...
var _AsideLeft = __webpack_require__(22);
...
var _AsideRight = __webpack_require__(23);
...
var _Thirds = __webpack_require__(24);
...
var Preview = _styledComponents2.default.div(_templateObject);

var ErrorBox = _styledComponents2.default.div(_templateObject2);
...
var Layout = function (_React$PureComponent) {
    ...
    function Layout() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args))), _this), _this.getChildComponents = function () {
            var _this$props = _this.props,
                children = _this$props.children,
                debug = _this$props.debug;

            if (debug) {
                var a = _react2.default.Children.map(children, function (element, idx) {
                    return _react2.default.createElement(
                        Preview,
                        { idx: idx },
                        _react2.default.createElement(element.type, element.props)
                    );
                });
                return a;
            }
            return children;
        }, _this.invalidLength = function (maxChildren, childLength) {
            return _react2.default.createElement(
                ErrorBox,
                null,
    ...
    Layout.prototype.render = function render() {
        var _props = this.props,
            ...
            rest = _objectWithoutProperties(_props, ['children', 'component', 'render']);

        var element = render ? render() : _react2.default.createElement(component);

        var childComponents = this.getChildComponents();
        if (element.type && element.type.options) {
            var maxChildren = element.type.options && element.type.options.maxChildren || -1;
            var minChildren = element.type.options && element.type.options.minChildren || -1;
...
Layout.propTypes = {
    debug: _propTypes2.default.debug,
